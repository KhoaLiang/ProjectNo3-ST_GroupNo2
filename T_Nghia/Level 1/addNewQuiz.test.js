...
describe("Tạo mới một bài kiểm tra trên Chrome Browser (20 testcases)", function () {
    ...
    describe("Equivalance class partioning technique ",  function () {
        ...
        it('Tạo mới một bài kiểm tra thất bại và hiển thông báo lỗi "Maximum of 255 characters" với tất cả các trường valid, trường Title invalid', async function() {
            ...
            await driver.sleep(1000);
            const nameDefault = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quiszz";
    ...
    describe("[Boundary value analysis technique",  function () {
        ...
        it('Tạo mới một bài kiểm tra thành công với tất cả các trường valid, trường Title có độ dài 255 ký tự', async function() {
            ...
            await driver.sleep(1000);
            const nameDefault = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quisz";
        ...
        it('Tạo mới một bài kiểm tra thành công với tất cả các trường valid, trường Title có độ dài 128 ký tự', async function() {
            ...
            await driver.sleep(1000);
            const nameDefault = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque pen";
...
describe("Tạo mới một bài kiểm tra trên Edge Browser (20 testcases)", function () {
    ...
    describe("Equivalance class partioning technique ",  function () {
        ...
        it("Tạo mới một bài kiểm tra thất bại và hiển thị ra lỗi với tất cả các trường valid, trường Time limit giá trị Invalid", async function() {
            ...
            // check error
            assert.match(currentURL, /^https:\/\/sandbox\.moodledemo\.net\/course\/modedit\.php.*/ , "Submit failed due to invalid time limit field.");
